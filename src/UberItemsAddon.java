...
public class UberItemsAddon extends JavaPlugin {
    ...
    private void registerUberItems() {
        ...
        UberItems.putItem("example_uber_item", new example_uber_item(Material.DIAMOND, "Example Uber Item",
        ...
        UberItems.putItem("midas_statue", new midas_statue(Material.SPONGE, "Midas Statue", UberRarity.LEGENDARY,
                false, false, true,
                Arrays.asList(
                        new UberAbility("Midas Step", AbilityType.RIGHT_CLICK, "(toggle) every block you step on turns into gold while holding this item"),
        ...
        UberItems.putItem("bishop_helmet", new bishop_helmet(Material.CHAINMAIL_HELMET, "Bishop Helmet", UberRarity.UNCOMMON,
                false, false, true,
                Arrays.asList(
                        new UberAbility("Strong Man", AbilityType.LEFT_CLICK, "Gives Strength II when right clicked. (toggle)")
                ),
                new UberCraftingRecipe(Arrays.asList(
        ...
        UberItems.putItem("bishop_chestplate", new bishop_chestplate(Material.IRON_CHESTPLATE, "Bishop Chestplate", UberRarity.UNCOMMON,
                false, false, true,
                Arrays.asList(
                        new UberAbility("Strong Man", AbilityType.LEFT_CLICK, "Gives Strength II when right clicked. (toggle)")
                ),
        ...
        UberItems.putItem("bishop_leggings", new bishop_leggings(Material.IRON_LEGGINGS, "Bishop Leggings", UberRarity.UNCOMMON,
                false, false, true,
                Arrays.asList(
                        new UberAbility("Strong Man", AbilityType.LEFT_CLICK, "Gives Strength II when right clicked. (toggle)")
                ),
        ...
        UberItems.putItem("bishop_boots", new bishop_boots(Material.IRON_BOOTS, "Bishop Boots", UberRarity.UNCOMMON,
                false, false, true,
                Arrays.asList(
                        new UberAbility("Strong Man", AbilityType.LEFT_CLICK, "Gives Strength II when right clicked. (toggle)")
                ),
